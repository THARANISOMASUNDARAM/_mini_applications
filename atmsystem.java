...
public class ATM {
    ...
    static String ATMBank = "State Bank";
    ...
    public static void miniStatement(){
        ...
        u[0]=new UserDetails("thara", 1233, 16700.00,"ts123","1234567","","SBI",0,0);
        u[1]=new UserDetails("praveen", 1231, 15000.00,"ya123","1234565","","SBI",0,0);
        u[2]=new UserDetails("Raghu", 1232, 15000.00,"ra123","1234563","","SBI",0,0);
        u[3]=new UserDetails("sobi", 1234, 11000.00,"so123","1234561","","SBI",0,0);
        u[4]=new UserDetails("vaish", 2314, 18000.00,"va123","1234569","","SBI",0,0);
    }
